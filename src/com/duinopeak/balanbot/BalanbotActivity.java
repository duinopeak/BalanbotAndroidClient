 ...
 *
 *
 * modify by Kevin.Liu, Duinopeak
 * Web      :  http://duinopeak.com
...
public class BalanbotActivity extends SherlockFragmentActivity implements ActionBar.TabListener {
    private static final String TAG = "Balanbot";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://duinopeak.com"));
    ...
    static class BluetoothHandler extends Handler {
        private final BalanbotActivity mBalanbotActivity;
        private String mConnectedDeviceName; // Name of the connected device

        BluetoothHandler(BalanbotActivity mBalanbotActivity) {
            this.mBalanbotActivity = mBalanbotActivity;
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MESSAGE_STATE_CHANGE:
                    mBalanbotActivity.supportInvalidateOptionsMenu();
                    if (D)
                        Log.i(TAG, "MESSAGE_STATE_CHANGE: " + msg.arg1);
                    switch (msg.arg1) {
                        case BluetoothChatService.STATE_CONNECTED:
                            BalanbotActivity.showToast(mBalanbotActivity.getString(R.string.connected_to) + " " + mConnectedDeviceName, Toast.LENGTH_SHORT);
                            if (mChatService == null)
                                return;
                ...
                case MESSAGE_READ:
                    ...
                    if (pairingWithDevice) {
                        ...
                        BalanbotActivity.showToast("Now enable discovery of your device", Toast.LENGTH_LONG);
                    }
                    break;
                ...
                case MESSAGE_DISCONNECTED:
                    ...
                    PIDFragment.updateButton();
                    if (msg.getData() != null)
                        BalanbotActivity.showToast(msg.getData().getString(TOAST), Toast.LENGTH_SHORT);
                    break;
                case MESSAGE_RETRY:
                    if (D)
                        Log.d(TAG, "MESSAGE_RETRY");
                    mBalanbotActivity.connectDevice(null, true);
                    break;
            }
        }
    }
